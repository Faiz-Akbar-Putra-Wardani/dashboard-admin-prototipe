...
const currentPageTitle = ref("Tambah Klien");
...
const storeClient = async () => {
  const confirm = await Swal.fire({
    title: "Simpan Data?",
    text: "Apakah kamu yakin ingin menambahkan klien baru?",
    icon: "question",
    ...
    >
      <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Isi kolom di bawah untuk menambahkan klien baru.
        </p>
      </div>

      <!-- Form -->
      <form @submit.prevent="storeClient" class="space-y-6">
        <!-- Nama Kategori -->
       ...
       <!-- Upload Gambar -->
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          >
            ...
            <span>{{ isSubmitting ? "Menyimpan..." : "Simpan Klien" }}</span>
          </button>
        </div>
      </form>
    </div>
