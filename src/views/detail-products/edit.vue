...
const fetchDetailProduct = async () => {
  try {
    ...
    console.log("=== FETCH DETAIL PRODUCT ===");
    console.log("Detail product data:", data);
    ...
    if (data.product) {
      ...
      console.log("Selected product set to:", selectedProduct.value);
    }
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
      ...
      <div v-if="isLoading" class="space-y-4">
        <div class="animate-pulse">
          ...
          <div class="h-10 bg-gray-200 dark:bg-gray-700 rounded mb-6"></div>
        </div>
        ...
        <form @submit.prevent="updateDetailProduct" class="space-y-6">
          ...
          <div v-if="activeTab==='general'" class="space-y-4">
            <div class="group relative">
              ...
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Ubah produk yang terkait dengan detail ini
              </p>
            </div>
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:justify-end mt-6">
            ...
            >
              ...
              <span>{{ isSubmitting ? 'Menyimpan...' : 'Perbarui Detail' }}</span>
            </button>
          </div>
        </form>
      </div>
