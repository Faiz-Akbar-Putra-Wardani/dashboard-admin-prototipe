...
const storeAdmin = async () => {
  ...
  const confirm = await Swal.fire({
    title: "Simpan Data?",
    text: "Apakah kamu yakin ingin menambahkan admin baru ini?",
    icon: "question",
  ...
  try {
    ...
    await Swal.fire({
      icon: "success",
      title: "Berhasil!",
      text: response.data.meta?.message || "Admin baru berhasil ditambahkan.",
      timer: 2000,
    ...
    >
      <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Lengkapi form di bawah untuk menambahkan admin baru ke sistem.
        </p>
      </div>
